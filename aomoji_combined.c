...
LGUI_T(KC_TAB),    KC_Q,    KC_W,    KC_E,           KC_R,                   KC_T,          KC_PGUP,      KC_HOME    , KC_Y            , KC_U          , KC_I    , KC_O      , KC_P     , KC_BSPACE       ,
      KC_LCTRL,    KC_A,    KC_S,    KC_D,           KC_F,                   KC_G,                                     KC_H            , KC_J          , KC_K    , LT(4,KC_L), KC_SCOLON, KC_ENTER        ,
...
_______,     _______, LCTL(KC_DOWN),   LCTL(KC_UP), LGUI(KC_RBRC),       KC_MPLY,                        KC_LEFT, KC_DOWN           , KC_UP         , KC_RGHT       , XXXXXXX, _______,
_______, KC__VOLDOWN,     KC__VOLUP, KC_AUDIO_MUTE,       XXXXXXX, LGUI(KC_LBRC), _______,      _______, XXXXXXX, LCTL(RSFT(KC_TAB)), LCTL(KC_TAB)  , XXXXXXX       , XXXXXXX, XXXXXXX,
...
_______, _______, _______, _______, _______, _______, _______,      _______, _______, KC_F11 , _______, _______, _______, _______,
_______, _______, _______, _______, _______,                                          _______, _______, _______, _______, _______,

                                             _______, _______,      _______, _______,
                                                      _______,      _______,
                                    _______, _______, _______,      KC_ACL1, KC_ACL0, KC_ACL2
)
};
