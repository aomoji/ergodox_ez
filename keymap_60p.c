...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(
    // left
    KC_GRAVE,         KC_1,         KC_2,       KC_3,       KC_4,       KC_5,       KC_F14,
    KC_TAB,           KC_Q,         KC_W,       KC_E,       KC_R,       KC_T,       KC_MINUS,
    KC_LCTRL,         KC_A,         KC_S,       KC_D,       KC_F,       KC_G,#include "ergodox_ez.h"
#include "debug.h"
#include "action_layer.h"
#include "version.h"
#include "keymap_german.h"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox(
    // left
    KC_ESC,           KC_F1,          KC_F2,          KC_F3,           KC_F4,          KC_F5,         KC_TRANSPARENT,
    KC_TRANSPARENT,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT, KC_PGUP,       KC_TRANSPARENT,
    KC_TRANSPARENT,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,  LGUI(KC_RBRC), KC_PGDOWN,
    KC_TRANSPARENT,   KC_TRANSPARENT, KC_TRANSPARENT, LGUI(LSFT(KC_C)),KC_TRANSPARENT, LGUI(KC_LBRC),KC_TRANSPARENT,
    ...
    KC_TRANSPARENT,   KC_TRANSPARENT, LCTL(RSFT(KC_TAB)),   LCTL(KC_TAB),          KC_TRANSPARENT, KC_TRANSPARENT,KC_TRANSPARENT,
...
uint32_t layer_state_set_user(uint32_t state) {
  ...
  [1] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT,   KC_TRANSPARENT, LALT(KC_LEFT),  LALT(KC_RIGHT),  RGUI(KC_SPACE), KC_TRANSPARENT,KC_TRANSPARENT,
                      KC_LEFT,        KC_DOWN,        KC_UP,           KC_RIGHT,       KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,   KC_TRANSPARENT, RSFT(KC_TAB),   KC_TAB,          KC_TRANSPARENT, KC_TRANSPARENT,KC_TRANSPARENT,
                                      KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT, KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,   KC_TRANSPARENT,
    KC_TRANSPARENT,
    KC_TRANSPARENT,   KC_TRANSPARENT, KC_TRANSPARENT
